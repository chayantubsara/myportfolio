...
const fieldsByModule: Record<string, FieldDefinition[]> = {
  ...
  Projects: [
    ...
    { key: 'documentationId', label: 'Public PDF path or document ID', help: 'For GitHub Pages use documents/projects/filename.pdf.' },
    { key: 'projectFile', label: 'Project PDF (GAS fallback)', type: 'file', accept: 'application/pdf', help: 'Optional: upload through GAS when no GitHub Pages path is used.' },
  ...
  Certifications: [
    ...
    { key: 'documentId', label: 'Public PDF path or document ID', help: 'For GitHub Pages use documents/filename.pdf. Otherwise keep the generated document ID.' },
    { key: 'certificateFile', label: 'Certificate PDF (GAS fallback)', type: 'file', accept: 'application/pdf', help: 'Optional: upload through GAS when no GitHub Pages path is used.' },
  ...
  Awards: [
    ...
    { key: 'documentId', label: 'Public PDF path or document ID', help: 'For GitHub Pages use documents/awards/filename.pdf.' },
    { key: 'awardFile', label: 'Award PDF (GAS fallback)', type: 'file', accept: 'application/pdf', help: 'Optional: upload through GAS when no GitHub Pages path is used.' },
  ...
  Resume: [
    ...
    { key: 'driveFileId', label: 'Public PDF path', help: 'For GitHub Pages use documents/resume-public.pdf.' },
    { key: 'resumeFile', label: 'Resume PDF (GAS fallback)', type: 'file', accept: 'application/pdf', help: 'Optional: upload through GAS when no GitHub Pages path is used.' },
  ...
  Documents: [
    ...
    { key: 'driveFileId', label: 'Public PDF path', help: 'For GitHub Pages use documents/filename.pdf.' },
    { key: 'documentFile', label: 'Document PDF (GAS fallback)', type: 'file', accept: 'application/pdf', help: 'Optional: upload through GAS when no GitHub Pages path is used.' },
